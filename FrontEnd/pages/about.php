...
<body>
    ...
    <section class="hero-section mt-5">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <h1 class="display-4 fw-bold mb-4">Transforming How Businesses Find Meeting Spaces</h1>
                    <p class="lead mb-4">Connecting businesses with unused meeting rooms to professionals who need flexible workspace solutions.</p>
                    <div class="d-flex gap-3">
                        <a href="#" class="btn btn-primary btn-lg px-4">Find a Space</a>
                        <a href="#" class="btn btn-outline-primary btn-lg px-4">List Your Space</a>
                    </div>
                </div>
                <div class="col-lg-6">
    ...
    <section class="py-5 bg-light">
        <div class="container">
            <div class="row text-center mb-5">
                <div class="col-12">
                    <h2 class="fw-bold mb-4">Benefits for Everyone</h2>
                </div>
            </div>
            
            <!-- Host Benefits -->
            <h3 class="text-center mb-4">For Hosts</h3>
            <div class="row mb-5">
                <div class="col-md-4 mb-4">
                    <div class="card benefit-card p-4">
                        ...
                        <h4>Generate Extra Revenue</h4>
                        <p>Turn your unused meeting rooms into a steady income stream without any additional overhead costs.</p>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="card benefit-card p-4">
                        ...
                        <p>You control when your spaces are available, ensuring they're only rented when it works for your schedule.</p>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="card benefit-card p-4">
                        ...
                        <p>Meet potential clients, partners, and collaborators when they utilize your space for their meetings.</p>
                    </div>
                </div>
            </div>
            
            <!-- Renter Benefits -->
            <h3 class="text-center mb-4">For Renters</h3>
            <div class="row">
                <div class="col-md-4 mb-4">
                    <div class="card benefit-card p-4">
                        <div class="benefit-icon">
                        ...
                        <h4>Find Spaces Anywhere</h4>
                        <p>Access professional meeting spaces in prime locations that would otherwise be unavailable or unaffordable.</p>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="card benefit-card p-4">
                        ...
                        <h4>Save Money</h4>
                        <p>Pay only for the time you need, avoiding expensive long-term commitments or overhead costs.</p>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="card benefit-card p-4">
                        ...
                        <p>Find and secure the perfect meeting space within minutes through our easy-to-use platform and app.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                    ...
                    <div class="card h-100 p-4">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <p class="text-muted mb-0">Founder, TechStart</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="card h-100 p-4">
                        ...
                        <p class="mb-3">"As a host, I've generated over $2,000 in extra revenue each month from our underutilized conference rooms. The platform is incredibly easy to use and the support team is fantastic."</p>
                        <div class="d-flex align-items-center">
                            <img src="../assets/images/50x50.svg" alt="User" class="rounded-circle me-3">
                            <div>
                                <h6 class="mb-0">Robert Garcia</h6>
                                <p class="text-muted mb-0">Office Manager, Elevate Inc.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="card h-100 p-4">
                        ...
                        <div class="d-flex align-items-center">
                            <img src="../assets/images/50x50.svg" alt="User" class="rounded-circle me-3">
                            <div>
                                <h6 class="mb-0">Samantha Wilson</h6>
                                <p class="text-muted mb-0">Independent Consultant</p>
                            </div>
                        </div>
                    </div>
                </div>
