        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="mb-12">
                <p class="text-gray-700 mb-6">
                    We built this platform to simplify how individuals, teams, and businesses schedule meetings. Whether
                    you're a freelancer needing a quiet space, a startup hosting a brainstorming session, or a corporate
                    team arranging client meetings, our system connects you with the right space at the right time.
                </p>

                <p class="text-gray-700 mb-6">
                    Our goal is to save your time and eliminate the hassle of manual booking and availability checking. With
                    real-time availability, easy filters, and secure booking, we bring flexibility and transparency to
            ...
            <p class="text-gray-700 text-lg mb-8">
                At <span class="font-semibold text-blue-600">Team Room</span>, we believe productive meetings start with the
                right space. Let us help you find it.
            </p>
