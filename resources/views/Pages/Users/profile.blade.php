            ...
            @if($spaces)
                @foreach ($spaces as $space)
                    <div class="bg-white rounded-lg shadow overflow-hidden">
                        <div class="relative">
                            <img src="{{ asset('storage/' . $space->images->first()->image_url) }}" alt="Executive Meeting Room" class="w-full h-48 object-cover">
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex justify-between items-center mb-3">
                                <div class="font-semibold text-gray-900">${{$space->hourly_rate}}<span class="text-gray-600 font-normal">/hour</span></div>
                                <div class="bg-green-100 text-green-800 text-xs font-medium px-2 py-1 rounded">Active</div>
                            </div>
                            <div class="flex space-x-2">
                                <a href="{{route('rooms.details', [$space->slug])}}" class="text-blue-500 hover:text-blue-600 text-sm font-medium">View details</a>
                            </div>
                        </div>
                    </div>
                @endforeach
