                                    ...
                                    @foreach ($activities as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @endphp
                                                <span
                                                    class="badge bg-{{ $typeClass }}-subtle text-{{ $typeClass }}">{{ $item->type }}</span>
                                            </td>
                                            <td>{{ $item->name }}</td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <i class="align-middle me-2 text-muted" data-feather="clock"
                                                        style="width: 14px; height: 14px;"></i>
                                                    <span
                                                        title="{{ (new DateTime($item->created_at))->format('Y-m-d H:i:s') }}">
