    ...
    <div class="row mb-4">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-shrink-0 avatar-lg rounded bg-primary bg-opacity-10 p-3 text-center">
                            <i class="align-middle text-primary" data-feather="star" style="width: 30px; height: 30px;"></i>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-shrink-0 avatar-lg rounded bg-success bg-opacity-10 p-3 text-center">
                            <i class="align-middle text-success" data-feather="award" style="width: 30px; height: 30px;"></i>
                        </div>
                        <div class="flex-grow-1 ms-3">
                            <h4 class="mb-0">{{ $reviews->avg('rating') ? number_format($reviews->avg('rating'), 1) : '0' }}</h4>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h4 class="mb-0">{{ $reviews->where('created_at', '>=', now()->subDays(7))->count() }}</h4>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-shrink-0 avatar-lg rounded bg-danger bg-opacity-10 p-3 text-center">
                            <i class="align-middle text-danger" data-feather="alert-triangle" style="width: 30px; height: 30px;"></i>
                        </div>
                        <div class="flex-grow-1 ms-3">
                            <h4 class="mb-0">{{ $reviews->where('rating', '<', 3)->count() }}</h4>
                            <p class="text-muted mb-0">Low Ratings (<3)</p>
                        </div>
                    </div>
                </div>
            </div>
