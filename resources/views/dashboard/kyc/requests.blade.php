        ...
        <div class="card mb-4">
            <div class="card-body py-3">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h1 class="h3 mb-0 fw-bold">KYC Verification Requests</h1>
                    ...
                    <div class="card-body">
                                        ...
                                        <div class="card h-100 border-0 shadow-sm">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center mb-3">
                                                    <div
                                                        class="avatar avatar-md bg-primary bg-opacity-10 text-primary rounded-circle me-3">
                                                        <span>{{ strtoupper(substr($user->first_name, 0, 1)) }}{{ strtoupper(substr($user->last_name, 0, 1)) }}</span>
                                                    </div>
                                                    <div>
                                                        <h5 class="card-title mb-0">{{ $user->first_name }}
                                                            {{ $user->last_name }}</h5>
                                                ...
                                                <div class="mb-3">
                                                    <div class="d-flex align-items-center mb-2">
                                                        <i class="align-middle me-2 text-primary" data-feather="calendar"
                                                            style="width: 16px; height: 16px;"></i>
                                                        <span class="fw-medium">Submitted:</span>
                                                        <span
                                                            class="ms-2">{{ $user->created_at->format('M d, Y') }}</span>
                                                    </div>
                                                    <div class="d-flex align-items-center">
                                                        <i class="align-middle me-2 text-primary" data-feather="file-text"
                                                            style="width: 16px; height: 16px;"></i>
                                                        ...
                                                        <a href="{{ asset('storage/' . $user->id_document_path) }}"
                                                            ...
                                                            <i class="align-middle" data-feather="eye"
                                                                style="width: 14px; height: 14px;"></i> View Document
                                                        </a>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header bg-success text-white">
                                                    <h5 class="modal-title" id="approveModalLabel">Approve KYC Verification
                                                    </h5>
                                                ...
                                                <div class="modal-body">
                                                    <div class="text-center mb-4">
                                                        ...
                                                        <h5>Approve {{ $user->first_name }} {{ $user->last_name }}'s KYC
                                                            Verification?</h5>
                                                        <p class="text-muted">This action will verify the user and grant
                                                            them host privileges.</p>
                                                    </div>
                                                    ...
                                                    <div class="card bg-light mb-3">
                                                        <div class="card-body">
                                                            ...
                                                            <p class="mb-1"><strong>Email:</strong> {{ $user->email }}
                                                            </p>
                                                            <p class="mb-0"><strong>User ID:</strong>
                                                                #{{ $user->id }}</p>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header bg-danger text-white">
                                                    <h5 class="modal-title" id="rejectModalLabel">Reject KYC Verification
                                                    </h5>
                                                    <button type="button" class="btn-close btn-close-white"
                                                        data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <div class="text-center mb-4">
                                                        ...
                                                        <h5>Reject {{ $user->first_name }} {{ $user->last_name }}'s KYC
                                                            Verification?</h5>
                                                        <p class="text-muted">This action will reject the user's KYC
                                                    ...
                                                    <form method="POST" action="{{ route('kyc.reject', $user) }}">
                                                        ...
                                                        <button type="submit" class="btn btn-danger w-100">Confirm
                                                            Rejection</button>
                                                    </form>
                                                </div>
                                                <div class="modal-footer">
                        ...
                        @else
                            <div class="text-center py-5">
                                ...
                                <p class="text-muted">There are currently no pending KYC verification requests in the
                                    system.</p>
                            </div>
                        @endif
                    </div>
