            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="exportDropdown">
                        <li><a class="dropdown-item" href="{{ route('export.excel', ['table' => 'transactions']) }}"><i
                                    class="fa-solid fa-file-excel me-2"></i>Excel</a></li>
                        <li><a class="dropdown-item" href="{{ route('export.pdf', ['table' => 'transactions']) }}"><i
                                    class="fa-solid fa-file-pdf me-2"></i>PDF</a></li>
                        <li><a class="dropdown-item" href="{{ route('export.csv', ['table' => 'transactions']) }}"><i
                    ...
                    @foreach ($transactions as $transaction)
                        <tr>
                            ...
                            <td>
                                ...
                                @else
                                    <span
                                        class="badge bg-secondary-subtle text-secondary">{{ $transaction->transaction_type ?? 'No Data'}}</span>
                                @endif
                            </td>
                            <td>
                            ...
                            <td>
                                ...
                                <small
                                    class="text-muted">{{ (new DateTime($transaction->created_at))->format('H:i:s') }}</small>
                            </td>
                            <td>
                                <div>{{ (new DateTime($transaction->updated_at))->format('Y-m-d') }}</div>
                                <small
                                    class="text-muted">{{ (new DateTime($transaction->updated_at))->format('H:i:s') }}</small>
                            </td>
                            <td>
                                <div class="d-flex justify-content-center gap-2">
                                    <a href="/dashboard/transactions/{{ $transaction->id }}" class="btn btn-sm btn-info"
                                        data-bs-toggle="tooltip" title="View Details">
                                        <i class="fa-solid fa-eye"></i>
                                    </a>
                                    <a href="/dashboard/transactions/{{ $transaction->id }}/edit" class="btn btn-sm btn-primary"
                                        data-bs-toggle="tooltip" title="Edit Transaction">
                                        <i class="fa-solid fa-edit"></i>
                                    </a>
                                    <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                        data-bs-target="#deleteModal{{ $transaction->id }}" title="Delete Transaction">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="deleteModalLabel{{ $transaction->id }}">Confirm
                                                    Delete</h5>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <p class="text-center mb-0">Are you sure you want to delete transaction
                                                    <strong>#{{ $transaction->booking_id }}</strong>?</p>
